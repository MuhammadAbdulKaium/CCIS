...
class DeviceAbsenttJob implements ShouldQueue
{
    ...
    public function __construct($studentId,$institute_id,$campus_id)
    {
        ...
        if(!empty($smsAttendace) && ($smsAttendace->count()>0)) {
            ...
            $presentStudentProfile = AttendanceUploadAbsent::where('std_id', $this->studentId)->first();
...
//        Log::info("Sms Log Check");
        ...
        $sendSms->sendSingleSms($batch_count,$smsApiPath,$smsMessage="absent",$smsSender_id,$this->institute_id);
