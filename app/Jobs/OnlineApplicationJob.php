...
class OnlineApplicationJob implements ShouldQueue
{
    ...
    public function __construct($applicantUser, $applicantPersonal)
    {
        //
        $this->applicantUser = $applicantUser;
        $this->applicantPersonal = $applicantPersonal;
        ...
        // message format
        $message="Online Application Submitted !!! Student Name: ".$applicantPersonal->std_name.", Username: ".$applicantUser->username.", Password: ".$applicantUser->username;
        $messageId = $this->setSmsMessage($message);
        $this->insertSmsLogData($applicantUser, $applicantPersonal->gud_phone, $messageId, 2);
    }
