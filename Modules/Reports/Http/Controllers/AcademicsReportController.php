...
class AcademicsReportController extends Controller
{
    ...
    $academicYears = $this->academicHelper->getAllAcademicYears();
        ...
        // return view with the variable
 return view('academics::manage-academics.modals.report-class-section-subject-student', compact('allAcademicsLevel','academicYears'));
    }
    ...
    $academicYears = $this->academicHelper->getAllAcademicYears();
        ...
        // return view with the variable
return view('academics::manage-academics.modals.report-class-section-student', compact('allAcademicsLevel','academicYears'));
    ...
    public function studentReportClassSubjectList(){
        ...
        // return view with the variable
return view('academics::manage-academics.modals.report-class-subject-student', compact('allAcademicsLevel','academicYears'));
