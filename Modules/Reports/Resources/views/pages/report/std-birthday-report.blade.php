                            ...
                            <div class="row section-seven">
                                <div class="col-md-12 col-xs-12 attendance-details">
                                    <div class="table-overflow table-responsive">
                                        <h3 class="atten-std-info atten-std-details font16">{{$reportDetails->class_name.' ('.$reportDetails->section_name.')'}} Birthday Report</h3>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="details-center">Birthday</th>
                                            </tr>
                                            </thead>
                                            ...
                                            @foreach($studentList as $index=>$std)
                                                <tr>
                                                    ...
                                                    <td>{{date('d M, Y', strtotime($std->student()->dob))}}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
