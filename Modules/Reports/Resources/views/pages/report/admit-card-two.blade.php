...
@if($studentList->count()>0 AND !empty($examRoutine) AND count($examRoutine)>0)
    ...
    @foreach($studentList as $index=>$student)
        ...
        <div class="first-col" style=" margin-top:{{$loopCounter>1?'20px':'5px'}}; height: 650px;">
            <div class="id-card-wrapper">
                <div class="id-card-row" style="width: 100%">
                    ...
                    <div class="inst-info text-center">
                        ...
                        <span style="font-size: 20px">{{$instituteInfo->address1}}</span>
                    </div>
                </div>
                <br>
                <br>
                ...
                <div class="id-card-row">
                    <table style="font-size: 12px;" width="100%" border="1px solid black" class="text-left routine">
                ...
                <div class="heading" style="margin-top:15px; font-size: 15px">
                ...
                <div class="id-card-row clear" style="margin-top: -10px;">
                    <table style="font-size: 13px" width="100%" border="1px solid black" class="text-center routine">
                        <thead>
                        <tr>
                            <th>Subject name</th>
