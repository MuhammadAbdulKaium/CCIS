<html lang="en"><head>
    ...
    <style>
        ...
        .stdImg img {border: 2px solid #f6f6f7;width:100%; height: 100%; border-radius: 10px;}
    ...
    <div class="text-center overflow mainWidth">
        ...
        @foreach($studentList as $index=>$stdInfo)
            ...
            <div class="singId floatLeft">
                <div class="imageId ">
                    <img src="{{asset('/assets/id-card/stjoseph.png')}}" alt="">
                </div>
                <div class="content">
                    <div class="singContent">
                        <div class="parmanentAddress text-left">
                            <i>
                                ...
                                <p>
                                    ...
                                    @if(!empty($stdInfo->studentAddress()))
                                        <b>Address:</b> {{$stdInfo->studentAddress()->address}}<br>
                                    @endif
                            ...
                            <div class="returnCard  text-center">
                                ...
                                <h4 style="font-size: 14px">St. Joseph's School and College, Bonpara</h4>
                                <p>Bonpara, Baraigram, Haroa-6430, Natore. <br>
                                    {{--checking campus--}}
                                    @if($campusId==20)
                                        01711412882,01719946111
                                    @else
                                        +8801710455821
                                    @endif
                                    <br>or to the Nearest Police Station.
                                </p>
                                <div>
                    ...
                    <div class="singContent" style="margin-left: 9px;">
                        ...
                        <div class="contData">
                            ...
                            <table class="table text-left table-bordered">
                                ...
                                <tr>
                                    <td>ID</td>
                                    <td colspan="3">{{$stdInfo->username}}</td>
                                </tr>
                                <tr>
                                    <td>Class</td>
                                    <td colspan="3">
                                        @if($studentEnroll->batch()->get_division())
                                            {{$studentEnroll->batch()->get_division()->name}}
                                        @else
                                            {{$studentEnroll->batch()->batch_name}}
                                        @endif
                                    </td>
                                </tr>
