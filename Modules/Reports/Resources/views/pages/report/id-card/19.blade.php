    ...
    <div class="text-center overflow mainWidth">
        ...
        @foreach($studentList as $index=>$stdInfo)
            ...
            <div class="singId floatLeft">
                <div class="imageId ">
                    <img src="{{asset('/assets/id-card/sa_college.jpg')}}" alt="">
                </div>
                <div class="content">
                    <div class="singContent">
                        <div class="parmanentAddress text-left">
                            ...
                            <div class="returnCard  text-center">
                                ...
                                <h4>Syed Ahmed College</h4>
                                <p>Sukhanpukur, Gabtoli, Bogra. <br>
                                    {{--checking campus--}}
                                    @if($campusId==20)
                                ...
                                <p class="cardValidti">This card is valid till Academic Year 2019 - 2020</p>
                            </div>
                        </div>
                    </div>
