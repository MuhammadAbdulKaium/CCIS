...
<div class="modal-header">
    ...
    <h4 class="modal-title"><i class="fa fa-plus-square"></i> Fees Waiver Report card</h4>
</div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                ...
                <div id="summary-report" class="tab-pane fade in active">
                    <form id="#" action="{{url('/fees/student/batch-section/waiver/list')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group batchValidation">
                                        ...
                                        <select id="batch" class="form-control feesBatch" name="batch" onchange="">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group sectionValidation">
                                        ...
                                        <select id="section" class="form-control feesSection" name="section">
