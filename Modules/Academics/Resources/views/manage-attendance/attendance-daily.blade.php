    ...
    <div class="row">
        <div class="box box-solid">
            <form id="attendanceStdSearchForm" method="POST">
                ...
                <input type="hidden" name="attendance_page_type" value="daily_attendance">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control pull-right" name="date" id="datepicker" type="text">
                                <div class="help-block"></div>
                            </div>
                        </div>
                    </div>
        ...
        $(function() { // document ready
            ...
            $('form#attendanceStdSearchForm').on('submit', function (e) {
                ...
                if(class_id && section_id){
                    // ajax request
                    $.ajax({
                        url: "{{ url('/academics/manage/attendance/getStudentDailyAttendance') }}",
                        type: 'POST',
                        cache: false,
                        data: $('form').serialize(),
                        datatype: 'application/json',
