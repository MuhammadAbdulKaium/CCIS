...
<div class="modal-header">
	...
	<h4 class="modal-title">
		<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Class-Section Monthly Attendance Report<br>
	</h4>
</div>
<form id="#" action="{{url('academics/attendance/upload/monthly/report')}}" target="_blank" method="post">
