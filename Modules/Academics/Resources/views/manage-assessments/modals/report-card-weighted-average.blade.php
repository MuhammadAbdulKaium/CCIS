        ...
        <form style="overflow: scroll">
            @for($i=0; $i<count($allSemester); $i++)
                @if(array_key_exists($allSemester[$i]['id'], $semesterResultSheet)==true)
                    ...
                    <table id="grade_book_setup_table" class="table table-bordered table-responsive table-striped text-center">
                        ...
                        <tr class="bg-info text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group">
                                                <input type="text" style="width: 180px" readonly class="form-control input-group text-center" value="Subject">
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                            ...
                            @if($gradeScale->assessmentsCount()>0)
                                    ...
                                    @foreach($gradeScale->assessmentCategory() as $category)
                                        ...
                                        @if($categoryWAMark>0)
                                            ...
                                            @if($assessmentList->count()>0)
                                                ...
                                                <th>
                                                    {{--category Name--}}
                                                    <p class="bg-gray-active">{{$category->name}} ({{$weightedAverageArrayList[$category->id]}})</p>
                                ...
                                @endif
                            @endif
                            <th width="80px" id="grade_book_setup_table_head_action_{{$allSemester[$i]['id']}}">
...
<script type="text/javascript">
    ...
    function load_grade_book(class_subjects_list, data, semester_id) {
        ...
        for(var i=0; i<class_subjects_list.length; i++){
            ...
            // tabe row data
            tr += '<td><table class="table-bordered table-responsive" cellpadding="10"><tbody><tr><td><div class="input-group text-center"><input style="min-width: 180px" type="text" readonly  value="'+sub_name+'" class="form-control"></div></td></tr></tbody></table></td>';
            ...
            for(x=0; x<custom_ass_cat_list.length; x++){
                ...
                var td = '<td><input type="hidden" name="grade[std_'+std_id+'][mark][cat_list][cat_'+x+']" value="'+cat_id+'"/><input type="hidden" name="grade[std_'+std_id+'][mark][cat_'+cat_id+'][cat_id]" value="'+cat_id+'"/><input type="hidden" name="grade[std_'+std_id+'][mark][cat_'+cat_id+'][ass_count]" value="'+ass_count+'"/><table class="table-bordered" cellpadding="10" width="100%"><tbody><tr>';
                ...
                if(mark['cat_'+cat_id] != undefined){
                    ...
                    for(var k=1; k<=ass_count; k++){
                        ...
                        if(ass_list[myAssId] != undefined){
                            ...
                            var my_ass_points = parseInt(assessment_info['point_list'][myAssId]);
...
//                                '</td>';
                        ...
                        category_weighted_average =  (isNaN(finalAssTotalMarks)?0:finalAssTotalMarks);
                    ...
                    // weighted average
                    td += '<td width="100px"><div class="input-group text-center"><input type="text" readonly value="'+category_weighted_average+' / '+category_assigned_mark+'" class="form-control text-center mark-input"></div></td>';
                    ...
                    for(var zz=0; zz<ass_count; zz++){
                        ...
                        var custom_ass_points = parseInt(assessment_info['point_list'][custom_ass_id]);
                        // checking custom_ass_points
                        if(custom_ass_points>0){
                            td += '<td><div class="input-group text-center"><input type="text" readonly value=" / +'+custom_ass_points+'" class="form-control text-center mark-input"></div></td>';
                        }else{
                            td += '<td><div class="input-group text-center"><input type="text" readonly value=" - " class="form-control text-center mark-input"></div></td>';
                        }
                    }
                    // weighted average
                    td += '<td width="100px"><div class="input-group text-center"><input type="text" readonly value="-" class="form-control text-center mark-input"></div></td>';
                }
            ...
            tr += '<td><table class="table-bordered" cellpadding="10"><tbody><tr><td><div class="input-group"><input type="text" readonly class="form-control text-center" value="'+percentage+'"><div class="input-group-addon">%</div></div></td></tr></tbody></table></td></tr>';
