                                    ...
                                    <th colspan="{{(6+$myAssessmentCounter)}}">
                                        ...
                                        @else
                                            @php
                                                ...
                                                $semesterMeritPosition=in_array($totalStdObtainedMarks, $meritList)?(array_search($totalStdObtainedMarks, array_values($meritList))+1):' N/A';
                                            @endphp
                                                ...
                                                <tr class="text-bold calculation" style="font-weight: 700; font-size: 13px;">
                                                    <th colspan="{{(2+$assessmentTotalCount)}}">
                                                        ...
                                                        @else
                                                            ...
                                                            <i> Merit Position: {{in_array($totalStdObtainedMarks, $meritListWithExtraMark)?(array_search($totalStdObtainedMarks, array_values($meritListWithExtraMark))+1):' N/A'}} </i>
                                                        @endif
                                                    </th>
                                                </tr>
                                            @endif
