<div class="modal-header">
	...
	<h4 class="modal-title">
		@if($type=='gender')
		<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Class-Section Average Gender Report<br>
		@elseif($type=='birthday')
			<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Class-Section Average Birthday Report<br>
		@else
			<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Class-Section Average Contact Report<br>
		@endif
	</h4>
</div>

@if($type=='gender')
	<form id="class-section-report-form" action="{{url('/reports/academics/class/section/average/gender')}}" method="post" target="_blank">
@elseif($type=='birthday')
	<form id="class-section-report-form" action="{{url('/reports/academics/class/section/average/birthday')}}" method="post" target="_blank">
@elseif($type=='religion')
	<form id="class-section-report-form" action="{{url('/reports/academics/class/section/average/religion')}}" method="post" target="_blank">
@else
	{{--contact--}}
	<form id="class-section-report-form" action="{{url('/reports/academics/class/section/average/contact')}}" method="post" target="_blank">
@endif
