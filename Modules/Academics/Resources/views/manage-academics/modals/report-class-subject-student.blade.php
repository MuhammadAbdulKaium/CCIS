<div class="modal-header">
	...
	<h4 class="modal-title">
		<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Class Subject Student Report<br>
	</h4>
</div>

	<form id="class-section-report-form" action="{{url('/student/report/class/subject/')}}" method="post" target="_blank">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					<select id="academic_year" class="form-control academic_year"
