...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Payroll | <small>Employee Salary Generate</small>
            </h1>
            <ul class="breadcrumb">
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click',".submit",function (e){
                let btn_name=$(this).data('btn-name');
                // e.preventDefault();
                if(btn_name=='generate')
                {
                    $.ajax({
                        url:'/payroll/salary/generate/store',
                        type:'POST',
                        cache: false,
                        data:$('form#salary_generate_form').serialize(),
                        datatype: 'html',
                ...
                {
                    $.ajax({
                        url:'/payroll/salary/process/store',
                        type:'POST',
                        cache: false,
                        data:$('form#salary_generate_form').serialize(),
                        datatype: 'html',
            ...
            {
                $.ajax({
                    url: '/employee/manage/search/payroll/generate',
                    type: 'POST',
                    cache: false,
