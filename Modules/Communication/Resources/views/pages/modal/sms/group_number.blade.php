        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        <form  method="post" id="add-group-form" action="/communication/add/group/number/store">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group control-group after-add-field">
                                    <input class="form-control teacher_name" name="phone_number[]" type="number" placeholder="add mobile number ">
