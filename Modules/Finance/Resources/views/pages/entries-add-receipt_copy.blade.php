    ...
    <div class="box box-body">
        <div style="padding:25px;">
            <div class="entry add form">
                ...
                <form action="/finance/entries/add/receipt" id="EntryAddForm" method="post" accept-charset="utf-8">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div style="display:none;">
                        <input type="hidden" name="_method" value="POST">
                        <input type="hidden" name="data[_Token][key]" value="c1f53e60d74b7b79ad7cd40cc13f1cac4760d606" id="Token1262200768">
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <input name="data[Entry][date]" class="form-control" id="student_dob" style="width:450px;" type="text" required="required">
                    </div>
                    <table class="table stripped extra">
                        <tbody>
                        <tr>
                            <th>Dr/Cr</th>
                            <th>Ledger</th>
                        ...
                        <tr>
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][0][dc]" class="dc-dropdown" id="Entryitem0Dc">
                            ...
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][0][ledger_id]" class="ledger-dropdown" id="Entryitem0LedgerId">
                            ...
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][0][dr_amount]" class="dr-item" type="text" id="Entryitem0DrAmount" disabled="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][0][cr_amount]" class="cr-item" type="text" id="Entryitem0CrAmount" disabled="">
                                </div>
                            </td>
                            <td>
											<span class="addrow">
                        ...
                        <tr>
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][1][dc]" class="dc-dropdown" id="Entryitem1Dc">
                            ...
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][1][ledger_id]" class="ledger-dropdown" id="Entryitem1LedgerId">
                                        <option value="0">(Please select..)</option>
                            ...
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][1][dr_amount]" class="dr-item" type="text" id="Entryitem1DrAmount" disabled="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][1][cr_amount]" class="cr-item" type="text" id="Entryitem1CrAmount" disabled="">
                                </div>
                            </td>
                            <td>
													<span class="addrow">
                        ...
                        <tr>
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][2][dc]" class="dc-dropdown" id="Entryitem2Dc">
                                        <option value="D" selected="selected">Dr</option>
                                        <option value="C">Cr</option>
                                    </select>
                                </div>
                            ...
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][2][ledger_id]" class="ledger-dropdown" id="Entryitem2LedgerId">
                                        <option value="0">(Please select..)</option>
                            ...
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][2][dr_amount]" class="dr-item" type="text" id="Entryitem2DrAmount" disabled="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][2][cr_amount]" class="cr-item" type="text" id="Entryitem2CrAmount" disabled="">
                                </div>
                            </td>
                            <td>
															<span class="addrow">
                        ...
                        <tr>
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][3][dc]" class="dc-dropdown" id="Entryitem3Dc">
                                        <option value="D" selected="selected">Dr</option>
                                        <option value="C">Cr</option>
                                    </select>
                                </div>
                            ...
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][3][ledger_id]" class="ledger-dropdown" id="Entryitem3LedgerId">
                                        <option value="0">(Please select..)</option>
                                    @foreach($ledgerList as $ledger)
                            ...
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][3][dr_amount]" class="dr-item" type="text" id="Entryitem3DrAmount" disabled="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][3][cr_amount]" class="cr-item" type="text" id="Entryitem3CrAmount" disabled="">
                                </div>
                            </td>
                            <td>
																	<span class="addrow">
                        ...
                        <tr>
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][4][dc]" class="dc-dropdown" id="Entryitem4Dc">
                                        <option value="D" selected="selected">Dr</option>
                                        <option value="C">Cr</option>
                                    </select>
                                </div>
                            ...
                            <td>
                                <div class="form-group-entryitem required">
                                    <select name="data[Entryitem][4][ledger_id]" class="ledger-dropdown" id="Entryitem4LedgerId">
                                        <option value="0">(Please select..)</option>
                                    @foreach($ledgerList as $ledger)
                            ...
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][4][dr_amount]" class="dr-item" type="text" id="Entryitem4DrAmount" disabled="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group-entryitem">
                                    <input name="data[Entryitem][4][cr_amount]" class="cr-item" type="text" id="Entryitem4CrAmount" disabled="">
                                </div>
                            </td>
                            <td>
																			<span class="addrow">
                    ...
                    <div class="form-group">
                        <label for="EntryTagId">Tag</label>
                        <select name="data[Entry][tag_id]" class="form-control" style="width:450px;" id="EntryTagId">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.addrow', function() {
                var cur_obj = this;
                $.ajax({
                    url: '/finance/entries/addrow/all',
                    success: function(data) {
