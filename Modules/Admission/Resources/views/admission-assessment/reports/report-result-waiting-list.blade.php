...
<div class="container">
	...
	<div class="section clear">
		<p class="label text-center row-second">Exam Information</p>
	...
	{{--personal info part--}}
	<div class="section clear">
		<p class="label text-center row-second"> {{$academicInfo->list_type." (".$academicInfo->batch_type.")"}} Result Sheet </p>
		<table width="100%" border="1px solid" class="report_card_table text-center" cellpadding="5">
			<thead>
			<tr class="row-second">
