		...
		<section class="content">
			...
			<div id="p0">
				<form id="applicant_enquiry_search_form">
					...
					<input type="hidden" name="search_type" value="enquiry">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group {{ $errors->has('applicant_status') ? ' has-error' : '' }}">
										<label class="control-label" for="applicant_status">Payment Type</label>
										<select id="applicant_status" class="form-control applicantStatus academicChange" name="status">
