   ...
   <ul class="nav navbar-nav">
      <li class="dropdown esmenu-full">
         ...
         {{--</a>--}}
            ...
            <a href="javascript:void(0)" data-target="#megamenu-items" data-toggle="collapse" class="navbar-toggle" style="margin-top: 3px;">
                  ...
                  <div class="tabbable row">
                     <div class="col-md-3">
                        <ul class="nav nav-pills nav-stacked">
                           <li>
                              <a href="#academics"><i class="fa fa-calendar-o"></i> Academics</a>
                           </li>
                           <li>
                              <a href="#hrms"><i class="fa fa-user"></i> Human Resource</a>
                           </li>
                           <li>
                              <a href="#student"><i class="fa fa-users"></i> Student</a>
                           </li>
                           <li>
                              <a href="#fees"><i class="fa fa-money"></i> Fees</a>
                           </li>
                           <li>
                              <a href="#communication"><i class="fa fa-comments"></i> Communication</a>
                           </li>
                           <li>
                              <a href="#reports"><i class="fa fa-line-chart"></i> Reports and Printing</a>
                           </li>
                           <li>
                              <a href="#administration"><i class="fa fa-wrench"></i> Administration</a>
                           </li>
                           <li>
                              <a href="#document"><i class="fa fa-file-text-o"></i> Document</a>
                           </li>
                           <li>
                              <a href="#library"><i class="fa fa-university"></i> Library</a>
                           </li>
                           <li>
                           ...
                           <div id="academics" class="tab-pane">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3 col-sm-4 col-xs-12">
                                    <div class="menu-box">
                                       <ul>
                                          <li><a href="/academics/attendance/"><i class="fa fa-check-square-o"></i> Student Attendance</a></li>
                                          <li><a href="/academics/attendance/"><i class="fa fa-check-square"></i> Manage Student Attendance</a></li>
                           ...
                           <div id="communication" class="tab-pane">
                              ...
                              <div class="row">
                                 <div class="col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <div class="menu-box">
                                       <ul>
                                          <li><a href="javascript:void(0);"><i class="fa fa-comment"></i> Notice</a></li>
                                 ...
                                 <div class="col-md-3 col-sm-4 col-xs-12">
                                    <div class="menu-box">
                                       <ul>
                                          ...
                                          <li><a href="/document-category/index"><i class="fa fa-reorder"></i> Document Category></a></li>
