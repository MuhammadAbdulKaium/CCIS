...
<div class="wrapper">
    ...
    <div class="logo-wrap">
        <div class="container-fluid">
            ...
            <div class="col-md-5" style="margin-bottom: 5px"><h2 class="school-name">
                    {{--institute profile checking--}}
                    @if(!empty(getInstituteProfile()))
                        {{--institute name--}}
            ...
            {{--<div class="col-md-2"><h4 class="campus-name">{{getCampusProfile()->name}}</h4></div>--}}
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.22.0/sweetalert2.min.css"></link>
@yield('scripts')
