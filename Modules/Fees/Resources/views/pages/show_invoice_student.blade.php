...
@section('page-content')
    ...
    <div class="col-md-12">
        <div class="innerAll shop-client-products cart invoice col-md-9">
                        ...
                        <table class="table table-borderless table-condensed cart_total">
                            ...
                            <tr>
                                ...
                                <td class="right" style="float: right">
                                    @php $subtotal=0; $totalAmount=0; $totalDiscount=0; $getAttendFine=0; $getDueFine=0;  @endphp
                            ...
                            <tr>
                                <td class="right">Total Amount Due:</td>
                                @if($invoice->invoice_status=="1")
                                    <td class="right strong" style="float: right">0</td>

                                @elseif($invoice->invoice_status=="2")
                                    <td class="right strong" style="float: right">{{$totalAmount+$getAttendFine+$getDueFine}}</td>
            ...
            <div>
                <label class="control-label">Extra Payments</label>
            </div>
            <table class="table table-bordered table-striped" style="font-size: 16px;">
                <thead>
                <tr>
                    <th style="width: 1%;" class="center">Id</th>
                    <th>Current Extra Payment</th>
