...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-plus-square"></i>Fees</h1>
                ...
                <div class="panel-body">
                    <div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-9">
                                    <form action="/fees/manage" method="post"  id="fees_and_fees_item_form" >
...
{{--                                            @if(!empty($fee->month))--}}
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <select id="selectMonth" class="form-control"  name="month" aria-required="true">
                                                        ...
                                                        @for($i = 1; $i <= 12;$i++)
                                                            ...
                                                            <option @if($i==date('m')) selected @endif value="{{$i}}">{{$date_str}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            ...
                                            <table class="col-md-12 col-sm-12 col-xs-12">
                                                <table class="table line-item-tbl" style="margin-top: 30px;">
                                                    ...
                                                    @if(!empty($fee))
                                                        @foreach($fee->feesItems() as $key=>$item)
                                                            <tr class="line-item-block item" id="row_{{$key+1}}">
                                                                ...
                                                                <input type="hidden" id="row_{{$key+1}}_item" name="{{$key+1}}[item_id]" value="{{$item->id}}">
                                                                <td class="td_name" style="border-bottom: 1px solid #ddd; "><div class="line-item-name-block"><input type="text" id="row_{{$key+1}}_name" class="form-control" @if(!empty($item->item_name)) value="{{$item->item_name}}" @endif  name="{{$key+1}}[item_name]"></div><div class="line-item-desc-block"></div></td>
                                                    ...
                                                    @else
                                                        <tr class="line-item-block item" id="row_1">
                                                            ...
                                                            <td class="td_name" style="border-bottom: 1px solid #ddd; "><div class="line-item-name-block">
                                                                    @if(!empty($allItems))
                                                                        <select  data-show-subtext="true" data-live-search="true" class="selectpicker form-control searchItem"  name="1[item_name]" id="row_1_name" required>
                                                                           <option value="">Select Item</option>
                                                                            @foreach($allItems as $items)
                                                                            <option id="{{$items->id}}" value="{{$items->item_name}}">{{$items->item_name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    @endif
                                                                </div><div id="row_1_name_error" class="line-item-desc-block"></div></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-sub-total-count" style="border-bottom: 1px solid #ddd; text-align: right;"><div class="line-item-block"><input type="text" class="form-control subTotalAmount" id="subTotal" value="0" readonly></div></td>
                                                    ...
                                                    <tr>
                                                        <td  colspan="3" class="td-discount"><a data-toggle="popover-x"
                                                                ...
                                                                Add Discount <span class="discountParcent"></span>
                                                             </a></td>
                                                        <td class="td-discount-count" style="border-bottom: 1px solid #ddd; text-align: right;"><div class="line-item-block"><input type="text" class="form-control fee-discount-total keydown-input-field" value="0" readonly></div></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-grand-total-count" style="border-bottom: 1px solid #ddd; text-align: right;"><div class="line-item-block"><input type="text" class="fee-paid-total form-control keydown-input-field" value="0" readonly></div></td>
                                ...
                                <div class="fees_template_button">
                                    <button type="button" id="add_fees_template" class="btn @if(!empty($fee->fee_status)=="1") add_fees_template_active  @else btn-primary @endif" @if(!empty($fee->fee_status)=="1") disabled @endif >Add Fees Template</button>
                                </div>
                                <div class="col-md-3  DisableDiv" id="PayersFeeSection" onload="javascript:payerSettingEnableById()">
                                    <div class="fee-setting-block" style="padding:15px;">
                                        <div class="fee-setting-title-block">
                                            <h3>Settings</h3>
                                            <span>For this fees</span>
                                        </div>
                                        <div class="payer-block" style="border-top: 1px solid #dfdfdf;padding: 15px 5px;">
                                            <div class="fee-opt-block-header inline-block"><i class="fa fa-user"></i> <span class="">Payers <a class="fees_payer_link" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg"> <span id="tp_count">0</span></a></span> </div>
                                            <a class="text-info pull-right" id="payer-block-link" href="javascript:void(0);" style="margin-right:5px;margin-top:3px;">Add Payers</a>
                                            <div class="clearfix"></div>
                                            <form id="class_section_form" action="/fees/batch/section/store" method="post">
                                                <input type="hidden" id="classSectionStudentSms" name="auto_sms" value="0">
                                                <div class="payers-options" style=" display:none; margin: 10px 0px;">
                                                    <div class="inline-block"><input class="payers_type" name="fees_payer_type_radio" id="payers_type_D" value="class" type="radio"> <label for="payers_type_D">Class - Section&nbsp;&nbsp; &nbsp; </label></div>
                                                    <div class="inline-block"><input class="payers_type" name="fees_payer_type_radio" id="payers_type_S" value="select-setudent" type="radio"> <label for="payers_type_S">Student</label></div>
                                                ...
                                                <div class="hidden-block" id="class" style="display: none">
                                                    ...
                                                    <div style="padding-left: 0px; padding-right: 0px;margin-top: 10px;">
                                                        <span  id="addAllClassSection" class="label label-primary" style="float: left;padding: 5px;cursor: pointer;"> Select All </span>
                                                        <span id="removeAllClassSection" class="label label-primary" style="float: right;padding: 5px;cursor: pointer;"> Remove All</span>
                                                        <br>
                                        ...
                                        {{--<div class="partially-paid-block" style="border-top: 1px solid #dfdfdf;padding: 15px 5px;">--}}
                                        {{--<div class="fee-opt-block-header inline-block"> <i class="fa fa-code-fork"></i> <span>Partial Payments</span></div>--}}
                                        {{--<div class="partially-paiment-options switch-block inline-block pull-right">--}}
                                        {{--<a href="javascript:void(0);" data-for="partial-payment" class="switch partial-payment-switch" data-val="0">--}}
                                        {{--<div class="switch-button-text" style="left: 0px;"></div>--}}
                                        {{--<form id="Partial_allowForm">--}}
                                        {{--<input type="hidden" name="_token" value="{{csrf_token()}}">--}}

                                        {{--<div class="radio">--}}
                                        {{--<label><input type="radio" name="partial_allowed" class="partial_payment" value="1" >Yes</label>--}}
                                        {{--</div>--}}
                                        {{--<div class="radio">--}}
                                        {{--<label><input type="radio" name="partial_allowed" class="partial_payment" value="0">No</label>--}}
                                        {{--</div>--}}
                                        {{--</form>--}}
                                        ...
                                        {{--<div class="recurring-payment-block" style=" border-bottom: 1px solid #dfdfdf;border-top: 1px solid #dfdfdf;padding: 15px 5px;">--}}
                                        {{--<div class="fee-opt-block-header inline-block"><i class="fa fa-refresh"></i> <span> Recurring Payment</span></div>--}}
                                        {{--<div style="margin-left:10px;margin-top: 8px;"> Add <a href="/fees/paymentGateway" class="text-info">Stripe Payment Gateway</a> to enable Recurring payments </div>--}}
                                        {{--</div>--}}
                                    </div>
                                </div>
...
//        }
        ...
        $(document).ready(function() {
            $("#removeAllClassSection").css("pointer-events", "none");
            class_section_search();

            $("#removeAllClassSection").click(function(){
                $("#addAllClassSection").css("pointer-events", "auto");
                $("#removeAllClassSection").css("pointer-events", "none");
                $("input[type='hidden']").remove();
                $('#class_section_form ul').empty();
                ...
                $("#addAllClassSection").append('<input type="hidden" id="checkSelectAll" name="selectAll" value="1">');
                var checkSelectAll=$("#checkSelectAll").val();

                $("#addAllClassSection").append('<input type="hidden" name="_token" value="{{csrf_token()}}">');
                $("#addAllClassSection").append('<input type="hidden" id="class_section_count" name="cs_count" value="0">');
                $("#addAllClassSection").append('<input type="hidden" name="fees_id" value="'+fees_id+'">');
                class_section_search();
        ...
        function class_section_search(){
            $('#class_section_form ul:last').hide();

            $.ajax({
                url: '/fees/batch/section/student',
                dataType: 'json',
                async: false,
        ...
        // Fees Edit Javascript all Functions

        function payerSettingEnableById(){
            subTotal();
            var fees_status=parseInt($("#fees_status").val());
            var fees_id=parseInt($("#get_fees_id").val());
            if(fees_id==0) {
                $("#PayersFeeSection").addClass("DisableDiv");
            }
            else {
                $("#PayersFeeSection").addClass("DisableDiv");
            }
        ...
        payerSettingEnableById();


        // Add a token programatically
        $("#addAllClassSection").click(function () {
            $("#addAllClassSection").css("pointer-events", "none");
            $("#removeAllClassSection").css("pointer-events", "auto");

            var checkSelectAll=$("#checkSelectAll").val();

            {{--$('#class_section_form ul:first').remove();--}}
            if(checkSelectAll!=1) {
                var tp_count = parseInt($('#tp_count').text());
                $('#tp_count').text(0);
                ...
                $("#addAllClassSection").append('<input type="hidden" id="class_section_count" name="cs_count" value="0">');
                $("#addAllClassSection").append('<input type="hidden" name="fees_id" value="'+fees_id+'">');
                $('#class_section_form ul').css("display",'block');
            }
            var cs_counter = parseInt($('#class_section_count').val());
        ...
        /// Token Input and get all class and section Data;
        $("#demo-input-local").tokenInput("/fees/batch/section/student",{
            preventDuplicates: true,
            searchDelay: 200,
        ...
        $('form#class_section_form').on('submit', function (e) {
            ...
            var fees_payer_url='/fees/payers/list/'+fees_id;
            ...
            swal({
                ...
                if (result.value) {
                    // ajax request
                    $("#classSectionStudentSms").val(1);

                    // ajax request
                    $.ajax({

                        url: '/fees/batch/section/store',
                        type: 'POST',
                        cache: false,
                        ...
                        success: function (data) {
                            ...
                            $(".fees_payer_link").attr("href", fees_payer_url);
                            setTimeout(function () {
                                swal("Success!", "Class Section Wise Payer Successfully Added", "success");
                            }, 2000);
                        },
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            var fees_status=parseInt($("#fees_status").val());
                            if(fees_id==0 && fees_status==1) {
                                $("#PayersFeeSection").addClass("DisableDiv");
                                $("#add_fees_template").attr('disabled', true);
                            } else {
                                $("#PayersFeeSection").removeClass("DisableDiv");
                                $("#add_fees_template").attr('disabled', true);
                            }

                            $(".add-item").addClass("removeAddItem");
                            $("#delete-icon").addClass("delete-icon-remove");
                            $('#PayerStudent').append('<input type="hidden" name="fees_id" value="'+data+'" />  <input type="hidden" name="_token" value="{{csrf_token()}}">');
                            $('#Partial_allowForm').append('<input type="hidden" name="fees_id" value="'+data+'" />');
                            $('#class_section_form').append('<input type="hidden" name="fees_id" value="'+data+'" />');
                            $('#GetFeesId').append('<label class="control-label" for="enrolled_at">Fees ID</label><input type="text" id="dueDate" class="form-control feesId_for_link" name="due_date" value="'+data+'" readonly><div class="help-block"></div>');
