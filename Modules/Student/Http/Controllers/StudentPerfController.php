...
class StudentPerfController extends Controller
{
    ...
    public function getStudentPerf($id, $type = null, Request $request)
    {
        ...
        return view('student::pages.student-profile.student-performance', compact('pageAccessData', 'personalInfo', 'performanceCategory', 'type'))->with('page', $pagename)->with('performance', 'Curriculum');
    }

    //get cariculam performance
    public function getStudentPerfCurriculam(Request $request, $categoryname, $typeid, $categoryid, $suid)
    {
        ...
        if ($categoryDtls->category_name == "Depression Scale") {
            ...
            return view('student::pages.student-profile.student-psychology', compact('pageAccessData', 'personalInfo', 'performanceCategory', 'assessment', 'categoryname', 'categoryid', 'typeid', 'range', 'suid'))->with('page', $pagename);
        ...
        return view('student::pages.student-profile.student-performance-cariculam', compact('pageAccessData', 'personalInfo', 'performanceCategory', 'assessment', 'categoryname', 'categoryid', 'typeid', 'activity', 'suid'))->with('page', $pagename);
    }
