...
class StudentPsycoController extends Controller
{
    ...
    public function getStudentPsyco($id)
    {
        ...
        return view('student::pages.student-profile.student-psychology', compact('personalInfo'))->with('page', 'psychology')->with('performance','curriculum');
    }
