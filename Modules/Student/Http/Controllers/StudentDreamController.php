...
class StudentDreamController extends Controller
{
    ...
    public function getStudentPsyco(Request $request,$id)
    {
        ...
        return view('student::pages.student-profile.student-dream', compact('personalInfo','pageAccessData','recordInfo'))->with('page', 'dream');
    }
