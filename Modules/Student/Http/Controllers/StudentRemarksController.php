...
class StudentRemarksController extends Controller
{
    ...
    public function getStudentRemarks($id,Request $request)
    {
        ...
        return view('student::pages.student-profile.student-remarks', compact('pageAccessData','personalInfo','recordInfo'))->with('page', 'remarks');
    }
