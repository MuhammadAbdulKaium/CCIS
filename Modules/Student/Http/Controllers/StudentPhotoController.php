...
class StudentPhotoController extends Controller
{
    ...
    public function getStudentPsyco($id ,Request $request)
    {
        ...
        return view('student::pages.student-profile.student-photo', compact('pageAccessData','personalInfo','studentProfile','studentPhoto'))->with('page', 'photo');
