...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Alumni | <small>Cadet</small>
            </h1>
            <ul class="breadcrumb">
                <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="/student/">Cadet</a></li>
                <li class="active">Alumni Cadet Manage</li>
            </ul>
        </section>
            ...
            <div class="box box-solid">
                <div class="et">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Search Alumni Cadet</h3>
                    </div>
                </div>
    ...
    <script>
        $(function () {
            ...
            $('form#std_manage_search_form').on('submit', function (e) {
                ...
                // ajax request
                $.ajax({
                    url: "/student/manage/alumni/search/",
                    type: 'POST',
                    cache: false,
