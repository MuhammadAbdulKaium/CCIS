...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Testimonial  | <small>Result</small>
            </h1>
            <ul class="breadcrumb">
            ...
            <div class="box box-solid">
                <div class="et">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Search Cadet Testimonal Result</h3>
                    </div>
                </div>
                <form id="std_manage_search_form" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="margin-top: 25px;">
                                <div class="form-group">
                                    <input id="email" class="form-control" name="email" placeholder="Enter Cadet Email Id." type="text">
                                    <div class="help-block"></div>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <label class="control-label" for="section">Result Type</label>
                                <div class="form-group">
                                    <select class="form-control" id="result_type" name="result_type" required>
    ...
    <script>
        $(function () {
            ...
            $('form#std_manage_search_form').on('submit', function (e) {
                ...
                // ajax request
                $.ajax({
                    url: "/student/testimonial/result/manage/search",
                    type: 'POST',
                    cache: false,
