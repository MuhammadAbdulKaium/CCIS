...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-th-list"></i> Report |<small>Cadet Warnings</small>
        </h1>
        <ul class="breadcrumb">
            <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
            <li><a href="/">Cadets</a></li>
            <li>Reports</li>
            <li class="active">Cadet Warnings</li>
        </ul>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title" style="line-height: 40px"><i class="fa fa-search"></i> Search Cadet & give warning </h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-2">
...
<div class="modal-dialog">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="warningModalLabel">Give Warning</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <form action="{{ url('/student/warnings') }}" method="POST">
        @csrf
        <div class="modal-body">
            <input type="hidden" class="hidden-student-field" name="stdId">
            <input type="hidden" class="hidden-year-field" name="yearId">
            <input type="hidden" class="hidden-term-field" name="termId">

            <div class="row">
                <div class="col-sm-12">
                    <textarea name="comment" class="form-control" cols="30" rows="1" placeholder="Comments"></textarea>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button class="btn btn-primary">Warn</button>
        </div>
    </form>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('.student-search-btn').click(function () {
            ...
            if (batchId && yearId && termId) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('/student/search/students/for/warning') }}",
                    type: 'GET',
                    cache: false,
                    data: {
                        '_token': $_token,
        ...
        $(document).on('click', '#warn-btn', function () {
            ...
            $('.hidden-student-field').val(stdId);
