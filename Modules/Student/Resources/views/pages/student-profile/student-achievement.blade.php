      ...
      <div class="tab-content">
         ...
         <div id="enroll_active" class="tab-pane fade in active">
            <div class="row">
               <div class="col-md-12">
                  <p class="text-right">
                     <a id="update-guard-data" class="btn btn-success float-right" href="/student/profile/fector/entity/creates/{{$personalInfo->id}}/8" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Records</a>
                  </p>
                  <br/>
