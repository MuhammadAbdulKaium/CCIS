		...
		<div class="tab-content">
			...
			<div id="enroll_active" class="tab-pane fade in active">
				<div class="row">
					<div class="col-md-12">
						<p class="text-right">
							<a id="update-guard-data" class="btn btn-success float-right" href="/student/profile/fector/entity/creates/{{$personalInfo->id}}/30" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Records</a>
						</p>
						<br/>
						<table class="table table-striped table-bordered text-center">
							...
							@foreach ($recordInfo as $item)
								...
								<tr>
									...
									<td>{{$item->remarks}}</td>
									<td>
										<a id="update-guard-data" class="btn btn-success float-right btn-xs" href="/student/performance/assessment/show/{{$personalInfo->id}}/{{$item->id}}" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg"><i class="fa fa-user-plus" aria-hidden="true"></i> Edit</a>
										<a href="/student/performance/assessment/delete/data/{{$item->id}}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-placement="top" data-content="delete"><i class="fa fa-trash-o"></i> Delete</a>
