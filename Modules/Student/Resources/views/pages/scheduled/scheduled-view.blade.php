...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Manage | <small> Task Scheduled </small>
            </h1>
            <ul class="breadcrumb">
                <li><a href="{{URL::to('/home')}}"><i class="fa fa-home"></i>Home</a></li>
                <li class="active">Manage Task Scheduled</li>
            </ul>
        </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="start_date" class="form-control" name="start_date" placeholder="Enter Cadet Number" type="date">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="col-sm-2" >
                                <div class="form-group">
                                    ...
                                    <input id="end_date" class="form-control" name="end_date" placeholder="Enter Cadet Roll" type="date">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        </div>
