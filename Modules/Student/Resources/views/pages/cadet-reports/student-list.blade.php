<table class="table" id="student-table">
    <thead>
        <tr>
            ...
            <th>Roll</th>
            <th>Mobile</th>
            @if(in_array('student/print/detail/reports', $pageAccessData))
            <th>Action</th>
            @endif
        </tr>
    </thead>
    <tbody>
        @forelse ($students as $student)
            <tr>
                ...
                @if(in_array('student/print/detail/reports', $pageAccessData))
                <td>
                    <button class="btn btn-sm btn-primary print-btn" data-student-id="{{ $student->std_id }}"><i class="fa fa-print"></i></button>
                </td>
                @endif
            </tr>
        @empty
