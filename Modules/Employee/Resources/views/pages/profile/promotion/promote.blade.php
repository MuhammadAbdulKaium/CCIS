    ...
    <section class="content">
        ...
        @endif
            ...
            <form action="{{url('/employee/promote/store')}}" method="POST">
                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="form-group">
                                                <div class="d-flex " style="display: flex;">
                                                    <input type="checkbox" id="customdate" class="checkbox " >
                                                        ...
                                                        <select id=""  class="form-control academicYear"
                                                            ...
                                                            @foreach($departments as $department)
                                                                ...
                                                                <option
                                                                        ...
                                                                        $employee->singleDepartment->id===$department->id)
                                                                                selected
                                                                                @endif
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <select id="section" class="form-control academicSection"
                                                            ...
                                                            <option value="1"  @if($employee->category==1) selected @endif
                                                                >Teaching</option>
                                                            <option value="2"  @if($employee->category==2) selected
                                                                    @endif
                                                            >Non Teaching</option>
<!--                                                            <option value="3"  @if($employee->category==3) selected
                                                                    @endif
                                                            >Officers</option>-->
                                                        </select>
                                                        <div class="help-block"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <input type="text" name="promotion_board" value="{{old
                                                        ('promotion_board')}}" required placeholder="board name"
                                                               class="form-control ">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
