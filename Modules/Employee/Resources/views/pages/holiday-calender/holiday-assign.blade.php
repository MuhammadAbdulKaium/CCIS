...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Manage  |<small>Holiday Calender Assign</small>
            </h1>
            <ul class="breadcrumb">
                <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Employee</a></li>
                <li><a href="#">Holiday</a></li>
                <li class="active">Holiday Calender Assign</li>
            </ul>
        </section>
                    ...
                    <div  class="admin-chart" style="padding: 9px;">
                        <div class="row">
                            <form method="POST" id="std_manage_search_form">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <select name="calender_year" id="" class="form-control" required>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        {
            $.ajax({
                url: "/employee/employee/search/holiday",
                type: 'POST',
                cache: false,
        ...
        $( document ).ready(function() {
            $(function () {
                ...
                $(document).on('submit', 'form#emp_assign_submit_form', function (e) {
                    ...
                    // ajax request
                    $.ajax({
                        url: "/employee/holiday/assign/form/submit/",
                        type: 'POST',
                        cache: false,
