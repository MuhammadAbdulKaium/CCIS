         ...
         @if($photoProfile = $employeeInfo->singelAttachment("PROFILE_PHOTO"))
         <form id="stu-photo-form" action="{{url('/employee/photo/update', [$photoProfile->id])}}" method="POST" enctype="multipart/form-data">
         @else
         <form id="stu-photo-form" action="{{url('/employee/photo/store')}}" method="POST" enctype="multipart/form-data">
