<div class="modal-header">
    ...
    <h4 class="modal-title">
        <i class="fa fa-plus-square"></i> Add Training Period
    </h4>
</div>
<form id="training-create" action="{{ url('/employee/profile/store/training') }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row" style="margin-bottom: 15px">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="training_institute" id="training_institute" placeholder="Institute of Training"
                        class="form-control">
                    <div class="help-block"></div>
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 15px">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="date" name="training_from" id="training_from" class="form-control"
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="date" name="training_to" id="training_to" class="form-control" placeholder="mm/dd/yy">
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="training_grading">Grading of Training <sup
                            style="color: red; font-size:18px; top:-1px;">*</sup></label>
                    <input type="text" name="training_grading" id="training_grading" placeholder="Grading of Training"
                        class="form-control">
                    <div class="help-block"></div>
                </div>
            </div>
