    ...
    <div class="modal-header">
        ...
        <p>
            ...
            <i class="fa fa-plus-square"></i> Create Role  Leave Assign</h4>
        <p></p>
    </div>
        ...
        <form name="add_name" id="add_name">
            ...
            <div class="row">
                <div class="col-sm-6" id="name">
                    <div class="form-group field-libraryborrowtransaction-name required">
                        <label class="control-label" for="libraryborrowtransaction-name">Role Name</label>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dynamic_field">
                    <tr>
                        <td><select name="category[]" id="" class="form-control"><option value="">Select Category</option><option value="">Casual</option></select></td>
