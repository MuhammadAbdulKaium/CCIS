 ...
 <div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title" style="line-height: 40px"><i class="fa fa-tasks"></i> HR Register</h3>
    </div>
     ...
     @foreach($designationWiseEmployee as $key=>$singleDesignationEmployee)
         ...
         @if(sizeof($singleDesignationEmployee) >0)
             <div class=" table-responsive">
                 <table id="myTable"  style="border-collapse: collapse" class="table table-bordered table-striped  display" border="2">
                     ...
                     <tr>
                         ...
                         <th class="text-center" rowspan="2">IMG</th>
