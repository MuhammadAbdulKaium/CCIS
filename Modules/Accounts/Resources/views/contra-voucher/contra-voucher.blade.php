                ...
                <section class="content">
                    ...
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <a v-if="dataList.pageAccessData['accounts/contra-voucher-data/create']" class="btn btn-success btn-sm" @click="openModal('addForm', 'contra-voucher-data/create',true)"><i class="fa fa-plus-square"></i> New</a>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <table class="table table-striped table-bordered m-b-0">
                                    ...
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>@{{list.remarks}}</td>
                                            <td>
                                                <template v-if="dataList.pageAccessData['accounts/contra-voucher.edit'] || dataList.pageAccessData['accounts/contra-voucher.delete'] || dataList.pageAccessData['accounts/contra-voucher.show'] || dataList.pageAccessData['accounts/contra-voucher.approval']">
                                                <a v-if="list.has_approval=='yes' && dataList.pageAccessData['accounts/contra-voucher.approval']" class="btn btn-primary btn-xs" @click="voucherApproval('contra-voucher-approval',list.id)"
                                                ><i class="fa fa-check-square" aria-hidden="true"></i> Approve</a>
                                                <a v-if="list.status==0 && !list.someOneApproved && dataList.pageAccessData['accounts/contra-voucher.edit']" class="btn btn-primary btn-xs" @click="openModal('addForm', 'contra-voucher-data/'+list.id+'/edit')" title="Edit"><i class="fa fa-edit"></i></a>
                                                <a v-if="list.status==0 && dataList.pageAccessData['accounts/contra-voucher.delete']"  @click="deleteItem(list.id)"
                                                   class="btn btn-danger btn-xs" data-placement="top"
                                                   data-content="delete" title="delete"><i class="fa fa-trash-o"></i></a>
                                                <a v-if="dataList.pageAccessData['accounts/contra-voucher.show']" class="btn btn-primary btn-xs" @click="openModal('detailsForm', 'contra-voucher-data/'+list.id)"
