...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Manage  |<small>Store transfer requisition</small>
            </h1>
            <ul class="breadcrumb">
                <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Inventory</a></li>
                <li class="active">Store transfer requisition</li>
            </ul>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-search"></i> Store Transfer  Requisition List </h3>
                    <div class="box-tools">
                        <a class="btn btn-success btn-sm" href="{{ url('inventory/store-transfer-requisition/create') }}" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-lg"><i class="fa fa-plus-square"></i> New</a></div>
                </div>
                <div class="box-body">
                    <form action="">
                        @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-xs"
                                        href="{{ url('inventory/store-transfer-requisition/1/edit') }}"
                                    ...
                                    <a href=""
                                     ...
                                     <a class="btn btn-primary btn-xs"
                                        href="{{ url('inventory/store-transfer-requisition/1') }}"
