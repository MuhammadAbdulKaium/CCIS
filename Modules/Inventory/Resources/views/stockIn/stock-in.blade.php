            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a v-if="dataList.pageAccessData['inventory/stock-in-data/create']" class="btn btn-success btn-sm" @click="openModal('addForm', 'stock-in-data/create',true)"><i class="fa fa-plus-square"></i> New</a>
                        </div>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>
                                                <template v-if="dataList.pageAccessData['inventory/stock-in.edit'] || dataList.pageAccessData['inventory/stock-in.delete'] || dataList.pageAccessData['inventory/stock-in.approval'] || dataList.pageAccessData['inventory/stock-in.show']">
                                                    <a v-if="list.has_approval=='yes' && dataList.pageAccessData['inventory/stock-in.approval']" class="btn btn-primary btn-xs" @click="voucherApproval('stock-in-approval',list.id)"
                                                    ><i class="fa fa-check-square" aria-hidden="true"></i> Approved</a>
                                                    <a v-if="list.status==0 && dataList.pageAccessData['inventory/stock-in.edit']" class="btn btn-primary btn-xs" @click="openModal('addForm', 'stock-in-data/'+list.stock_in_id+'/edit')" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a v-if="list.status==0 && dataList.pageAccessData['inventory/stock-in.delete']"  @click="deleteItem(list.id)"
                                                        class="btn btn-danger btn-xs" data-placement="top"
                                                        data-content="delete" title="delete"><i class="fa fa-trash-o"></i></a>
                                                    <a v-if="dataList.pageAccessData['inventory/stock-in.show']" class="btn btn-primary btn-xs" @click="openModal('detailsForm', 'stock-in-data/'+list.stock_in_id)" 
                        ...
                        <div class="row">
                            <div class="col-sm-2 p-t-15">
                                <button v-if="dataList.pageAccessData['inventory/stock-in.delete']" @click="deleteArrayItem()" class="btn btn-danger">Delete</button>
