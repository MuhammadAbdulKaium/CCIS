...
<div class="modal-body">
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 p-b-15">
                    <select name="req_type" id="req_type" class="form-control" required>
                        <option value="0">Dirrect Sales</option>
                    </select>    
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8 p-b-15">
                    <input type="text" class="form-control" required placeholder="DSO-001">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 p-b-15">
                    <select name="req_type" id="req_type" class="form-control" required>
                        <option value="0">By quality</option>
                    </select>    
                </div>
            </div>
    ...
    <p style="margin-top: 6px;margin-bottom: 0"><b>Choose Stock Out Item: </b></p> 
    ...
    <table class="responsive table table-striped table-bordered" cellspacing="0">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center" valign="middle">5</td>
                ...
                <td class="text-center" valign="middle">
                    <input type="number" name="price" class="form-control" autocomplete="off" placeholder="Price" value="100"> 
                </td>
                <td class="text-center" valign="middle">500</td>
