...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list"></i> Manage  |<small>Sales Challan </small>
            </h1>
            <ul class="breadcrumb">
                <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Inventory</a></li>
                <li><a href="#">Sales</a></li>
                <li class="active">Sales Challan</li>
            </ul>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-search"></i> Sales Challan List </h3>
                    <div class="box-tools">
                        <a class="btn btn-success btn-sm" href="{{ url('inventory/sales-challan/create') }}"><i class="fa fa-plus-square"></i> New</a></div>
                </div>
                <div class="box-body">
                    <form action="">
                        @csrf
                                    ...
                                    <td>
                                        ...
                                        <a href=""
                                         ...
                                         <a class="btn btn-primary btn-xs"
                                            href="{{ url('inventory/sales-challan/1') }}"><i class="fa fa-info-circle" aria-hidden="true"></i> Details</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
