...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-edit"></i> Edit Sales order
            </h1>
            <ul class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box box-solid">
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary">Update</button>   <a class="btn btn-default" href="{{url('inventory/sales-order')}}">Cancel</a>
                </div>
            </div>
            </form>
        </section>
