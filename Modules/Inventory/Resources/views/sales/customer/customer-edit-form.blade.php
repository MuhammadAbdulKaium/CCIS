            ...
            <section class="content">                
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary" :disabled="buttonDisabled">Update</button>   <a class="btn btn-default" href="{{url('inventory/customer')}}">Cancel</a>
                    </div>
                </div>
                </form>
            </section>
...
<script>
    ...
    var app = new Vue({
      ...
      created(){
        var id  = "{{$id}}";
        this.edit_id = id;
        this.formPageData('customer-edit-form-data/'+id);
      },
      methods:{
                    ...
                    axios.post(URL, formReqData, {
                        ...
                        if (res.data.status == 'logout') {
                            ...
                            if (res.data.status == 1) {
                                _this.customerFormData('customer-edit-form-data/'+_this.edit_id);
                            }
