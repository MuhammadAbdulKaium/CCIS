        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        @if(in_array('inventory/add/stock-category', $pageAccessData))
                        <a class="btn btn-success btn-sm" href="{{ url('inventory/add/stock-category') }}" data-target="#globalModal" data-toggle="modal" data-modal-size="modal-md"><i class="fa fa-plus-square"></i> New</a>
                        @endif
                    </div>
                </div>
                <div class="box-body">
                            ...
                            @if($stockCategory)
                                @foreach($stockCategory as $k=> $category)
                                    <tr>
                                        ...
                                        <td>
                                            @if(in_array('inventory/stock-category.edit', $pageAccessData) || in_array('inventory/stock-category.delete', $pageAccessData))
                                                @if(in_array('inventory/stock-category.edit', $pageAccessData))
                                                ...
                                                @endif
                                                @if(in_array('inventory/stock-category.delete', $pageAccessData))
