    ...
    <div class="content-wrapper">
        <div v-if="!pageLoader">
            <section class="content-header">
                <h1>
                    <i class="fa fa-plus-square"></i> Update Vendor
                </h1>
                <ul class="breadcrumb">
            ...
            <section class="content">                
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary" :disabled="buttonDisabled">Update</button>   <a class="btn btn-default" href="{{url('inventory/vendor')}}">Cancel</a>
                    </div>
                </div>
                </form>
            </section>
...
<script>
    ...
    var app = new Vue({
      ...
      created(){
        var id  = "{{$id}}";
        this.edit_id = id;
        this.formPageData('vendor-edit-form-data/'+id);
      },
      methods:{
                    ...
                    axios.post(URL, formReqData, {
                        ...
                        if (res.data.status == 'logout') {
                            ...
                            if (res.data.status == 1) {
                                _this.vendorFormData('vendor-edit-form-data/'+_this.edit_id);
                            }
