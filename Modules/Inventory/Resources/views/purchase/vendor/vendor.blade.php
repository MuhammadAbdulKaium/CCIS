            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <a v-if="dataList.pageAccessData['inventory/vendor-data/create']" class="btn btn-success btn-sm" href="{{ url('inventory/vendor-data/create') }}"><i class="fa fa-plus-square"></i> New</a>
                        </div>
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    <template v-if="Object.keys(paginate_data).length > 0">
                                        <tr v-for="(list, index) in paginate_data" v-bind:key="index">
                                            ...
                                            <td>
                                                <template v-if="dataList.pageAccessData['inventory/vendor.edit'] || dataList.pageAccessData['inventory/vendor.delete'] || dataList.pageAccessData['inventory/vendor.show']">
                                                    <a v-if="dataList.pageAccessData['inventory/vendor.edit']" class="btn btn-primary btn-xs" :href="baseUrl+'/vendor-data/'+list.id+'/edit'" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a v-if="dataList.pageAccessData['inventory/vendor.delete']" @click="deleteItem(list.id)"
                                                        class="btn btn-danger btn-xs" data-placement="top"
                                                        data-content="delete" title="delete"><i class="fa fa-trash-o"></i></a>
                                                    <a v-if="dataList.pageAccessData['inventory/vendor.show']" class="btn btn-primary btn-xs" :href="baseUrl+'/vendor-data/'+list.id"   @click="openModal('detailsForm', 'vendor-data/'+list.id)" 
