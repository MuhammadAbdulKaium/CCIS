        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-body scroll-table">
                    <form action="{{url('inventory/purchase-return/create')}}" method="get">
                    <div class="row">
                        <div class="col-sm-11">
                            <div class="form-group"  style="width: 100%">
                                <label class="col-md-2 control-label required p-r-0">Party</label>
                                <div class="col-md-4">
                                    <select name="party_id" id="party_id" style="width:100%;" class="select2" >
                                        <option value="">-- Party list --</option>
                                        <option <?php if($party_id==1) echo 'selected'; ?> value="1">-- Party 1 --</option>
                                        <option  <?php if($party_id==2) echo 'selected'; ?> value="2">-- Party 2 --</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-success purchase-receive-search"><i class="fa fa-search" aria-hidden="true"></i>
                                        Search</button>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 p-b-15">
                                    <input type="text" class="form-control" required placeholder="PORET-001">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 p-b-15">
                                    <select name="req_type" id="req_type" class="form-control select2" required>
                                        ...
                                        <option value="0">Purchase Receive</option>
                                    </select>                                                   
                                </div>
                            </div>
                    ...
                    <table class="responsive table table-striped table-bordered" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td valign="middle">
                                    <input type="number" name="" placeholder="qty" min="0" style="width: 80px">
                                </td>              
                    ...
                    <button type="submit" class="btn btn-primary">Return</button>   <a class="btn btn-default" href="{{url('inventory/purchase-return')}}">Cancel</a>
                    </form>
                    <?php } ?>
