...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-plus"></i> Purchase Receive
            </h1>
            <ul class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-body scroll-table">
                    <form action="{{url('inventory/purchase-receive/create')}}" method="get">
                    <div class="row">
                        <div class="col-sm-11">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 p-b-15">
                                    <select name="req_type" id="req_type" class="form-control select2" required>
                                        <option value="0">Md. shobhan</option>
                                    </select>                                                   
                                </div>
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary">Receive</button>   <a class="btn btn-default" href="{{url('inventory/purchase-receive')}}">Cancel</a>
                    </form>
                    <?php } ?>
...
<script>
    ...
    $(document).ready(function() {
        /*$('.purchase-receive-search').on('click', function(){
