...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                <i class="fa fa-plus"></i> Purchase Receive Details
            </h1>
            <ul class="breadcrumb">
                <li><a href="/"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Inventory</a></li>
                <li><a href="#">Purchase</a></li>
                <li class="active">Purchase Receive Details</li>
            </ul>
        </section>
        ...
        <section class="content">
            <div class="box box-solid">
                ...
                <div class="box-footer">
                   <a class="btn btn-default" href="{{url('inventory/purchase-receive')}}">Cancel</a>
                </div>
            </div>
        </section>
    </div>    
