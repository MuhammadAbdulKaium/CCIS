...
class CreateInventoryDirectStockInDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_direct_stock_in_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('inventory_direct_stock_in_details');
    }
}
