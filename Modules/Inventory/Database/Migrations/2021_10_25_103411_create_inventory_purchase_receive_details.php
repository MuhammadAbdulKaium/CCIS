...
class CreateInventoryPurchaseReceiveDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_purchase_receive_details', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('pur_receive_id');
            $table->integer('item_id');
            $table->decimal('rec_qty',18,6)->nullable();
            $table->decimal('app_rec_qty',18,6)->nullable();
    ...
    {
        Schema::dropIfExists('inventory_purchase_receive_details');
    }
}
