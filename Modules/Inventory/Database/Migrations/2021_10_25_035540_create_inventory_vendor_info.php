...
class CreateInventoryVendorInfo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_vendor_info', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('inventory_vendor_info');
    }
}
