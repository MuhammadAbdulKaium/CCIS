...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-plus-square"></i>Report Money Receipt</h1>
                ...
                <div class="panel-body">
                    <div>
                        <ul class="nav-tabs margin-bottom nav" id="">
                            <li @if($page == "feereceipt") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/money-receipt/feereceipt')}}">Fee Receipt</a>
                            </li>

                            {{--<li @if($page == "duereceipt") class="active" @endif  id="#">--}}
                                {{--<a href="{{url('/fee/report/money-receipt/duereceipt')}}">Due Receipt</a>--}}
                            {{--</li>--}}

                            <li @if($page == "latefinereceipt") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/money-receipt/latefinereceipt')}}">Late Fine Receipt</a>
                            </li>
                            <li @if($page == "absentfinereceipt") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/money-receipt/absentfinereceipt')}}">Absent Fine Receipt</a>
                            </li>
                        </ul>
                        <!-- page content div -->
                        @yield('page-content')
