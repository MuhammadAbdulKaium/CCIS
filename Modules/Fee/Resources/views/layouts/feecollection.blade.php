...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-plus-square"></i>Fee Collection</h1>
                ...
                <div class="panel-body">
                    <div>
                        <ul class="nav-tabs margin-bottom nav" id="">
                            <li @if($page == "single") class="active" @endif  id="#">
                                <a href="{{url('/fee/collection/single')}}">Single</a>
                            </li>

                            <li @if($page == "multiple") class="active" @endif  id="#">
                                <a href="{{url('/fee/collection/multiple')}}">Multiple</a>
                            </li>

                            <li @if($page == "due-fee-collection") class="active" @endif  id="#">
                                <a href="{{url('/fee/collection/due-fee-collection')}}">Due Fee</a>
                            </li>
                        </ul>
                        <!-- page content div -->
                        @yield('page-content')
