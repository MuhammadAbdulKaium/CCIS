...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-plus-square"></i>Report Collection Amount</h1>
                ...
                <div class="panel-body">
                    <div>
                        <ul class="nav-tabs margin-bottom nav" id="">
                            <li @if($page == "feedetails") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/collection-amount/feedetails')}}">Fee Details</a>
                            </li>



                            <li @if($page == "monthwise") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/collection-amount/monthwise')}}">Month Wise</a>
                            </li>
                        </ul>
                        <!-- page content div -->
                        @yield('page-content')
