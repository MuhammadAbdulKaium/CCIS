...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><i class="fa fa-plus-square"></i>Report Due Amount</h1>
                ...
                <div class="panel-body">
                    <div>
                        <ul class="nav-tabs margin-bottom nav" id="">
                            <li @if($page == "student-wise") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/due-amount/student-wise')}}">Student Wise</a>
                            </li>

                            <li @if($page == "fee-wise") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/due-amount/fee-wise')}}">Fee Wise</a>
                            </li>

                            <li @if($page == "absent-fine") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/due-amount/absent-fine')}}">Absent Fine</a>
                            </li>

                        <li @if($page == "all-student") class="active" @endif  id="#">
                                <a href="{{url('/fee/report/due-amount/all-student')}}">Custom Due Report</a>
                            </li>
