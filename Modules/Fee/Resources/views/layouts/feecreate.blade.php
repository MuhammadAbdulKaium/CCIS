...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h3><i class="fa fa-plus-square"></i>Fee Create</h3>
                ...
                <div class="panel-body">
                    <div>
                        <ul class="nav-tabs margin-bottom nav" id="">
                            <li @if($page == "generalfee") class="active" @endif  id="#">
                                <a href="{{url('/fee/create/generalfee')}}">Fee Create</a>
                            </li>

                            <li @if($page == "feelist") class="active" @endif  id="#">
                                <a href="{{url('/fee/create/feelist')}}">Created Fee List</a>
                            </li>

                            <li @if($page == "feefine") class="active" @endif  id="#">
                                <a href="{{url('/fee/create/feefine')}}">Fee Fine</a>
                            </li>

                            <li @if($page == "finelist") class="active" @endif  id="#">
                                <a href="{{url('/fee/create/finelist')}}">Fine List</a>
                            </li>
                        </ul>
                        <!-- page content div -->
                        @yield('page-content')
