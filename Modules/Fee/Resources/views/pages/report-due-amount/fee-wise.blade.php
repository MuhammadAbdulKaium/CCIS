@extends('fee::layouts.feereport-due-amount')
@section('page-content')
    ...
    <div class="box-body">
        {{--fee head create--}}
        <form id="multipleStudentSearchForm" action="{{URL::to('/fee/report/due-amount/fee-wise/download')}}" method="post">
            <div class="row">
    ...
    <div class="box-body studentInvoiceList table-responsive">
...
@section('page-script')
    <script>
        ...
        $('.search').click(function(e) {
            ...
            // ajax request
            $.ajax({
                url: '/fee/due-fee-wise/studentlist',
                type: 'POST',
                cache: false,
                data: $('form#multipleStudentSearchForm').serialize(),
                ...
                success:function(data){
                    $('.studentInvoiceList').html("");
                    $('.studentInvoiceList').append(data);
                },
