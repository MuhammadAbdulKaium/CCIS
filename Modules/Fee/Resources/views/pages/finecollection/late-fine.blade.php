...
@section('page-content')
    ...
    <div class="box-body">
        {{--fee head create--}}
        <form id="lateFineSearchForm" method="post">
            <div class="row">
    ...
    <div class="box-body latefinelist table-responsive">
...
@section('page-script')
    <script>
        ...
        $('#lateFineSearchForm').submit(function(e) {
            e.preventDefault();
            // ajax request
            $.ajax({
                url: '/fee/fine-collection/late-fine',
                type: 'POST',
                cache: false,
                data: $('form#lateFineSearchForm').serialize(),
