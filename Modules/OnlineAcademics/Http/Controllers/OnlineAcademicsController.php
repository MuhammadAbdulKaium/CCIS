...
class OnlineAcademicsController extends Controller
{
    ...
    public function getTopicInfo(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if (!empty($class_topic)) {
                ...
                // all academics year
                $academicYears  = $this->academicsYear->where()->get();
                $topic_name = "classtopic";
    ...
    public function ClassHistory(Request $request)
    {
        ...
        $ClassName = $this->batch->where(['academics_level_id' => $level, 'campus' => $campus_id, 'id' => $batch])->first();

        $SectionName = $this->section->where(['batch_id' => $batch])->first();
    ...
    public function ClassHistory_old(Request $request)
    {
        ...
        $ClassName = $this->batch->where(['academics_level_id' => $level, 'id' => $batch])->first();
