...
class OnlineAcademicsController extends Controller
{
  ...
  $empList        = EmployeeInformation::where('institute_id', institution_id())->where('campus_id',campus_id())->where('status',1)->get();
    ...
    public function ClassSchedule(Request $request)
    {
        ...
        $ClassScheduledId           = $institute_id.$campus_id.$academic_level_id.$academic_class_id.$academic_section_id.$academic_shift_id.$class_subject_id.$class_teacher_id;
    ...
    public function LiveClassScheduled($scheduledId){
        ...
        return view('onlineacademics::pages.onlineclass',compact('topic_name','academicYears','subjectList','topic_list','empList','allAcademicsLevel','ScheduledData','scheduledId'))->with('page');
    }
