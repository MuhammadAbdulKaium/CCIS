...
<div class="wrapper">
    ...
    <div class="logo-wrap">
        <div class="container-fluid">
            <div class="col-md-6">
                <a href="{{URL::to('/')}}" class=""><img src="{{URL::to('/assets/users/images/mapleleaf.png')}}" class="brand-logo" alt="Alokito logo"></a>
            </div>
...
<footer class="footer">
    <div class="container-fluid">
        <div class="col-md-6">
            <p class="copyright-footer-2">Alokito Softwares</p>
        </div>
        <div class="col-md-6">
