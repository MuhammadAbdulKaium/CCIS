...
<head>
    ...
    <title>Alokito Software Login</title>
    ...
    <style type="text/css">
        ...
        .school {
            background-color: #4591E1 !important;
            min-height: 300px
        }
...
<div class="container-fluid formplexy">
    <!-- Logo -->
    <!-- Form Base -->
    <div class="form-base col-lg-8 school">
        ...
        <section class="school-details">
            ...
            <h3>Shaheen Education Family</h3>
            <div class="school-logo">
                <img src="{{asset('assets/login/saheenlogo.png')}}" class="img-responsive">
            </div>

            <div class="owl-carousel owl-theme">
                <div class="item"><img class="slider-image" src="{{asset('assets/login/1.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/2.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/3.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/4.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/5.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/6.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/7.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/8.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/9.jpg')}}"/></div>
                <div class="item"><img class="slider-image" src="{{asset('assets/login/10.jpg')}}"/></div>
