...
<div class="container-fluid formplexy flipit">
    ...
    <div class="form-base col-lg-4 login-side">
        ...
        <section>
            ...
            @endif
            <form class="form-signin" role="form" method="POST" action="/forgot-password/check" id="login-form">
                {{ csrf_field() }}
                ...
                <div class="row section-action">
                    <!-- Submit -->
                    <button class="btn primary pull-left custom-color-back">Reset Password</button>
                </div>
            </form>
        </section>
