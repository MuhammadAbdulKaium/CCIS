         ...
         <ul class="dropdown-menu">
            ...
            <li>
               ...
               <ul class="menu">
                  <li>
                     <a href="#">
                        <i class="fa fa-users text-aqua"></i> Notification One ......
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <i class="fa fa-users text-aqua"></i> Notification Two ......
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <i class="fa fa-users text-aqua"></i> Notification Three ......
                     </a>
                  </li>
                  {{--<li>--}}
                     {{--<a href="#">--}}
                        {{--<i class="fa fa-users text-aqua"></i> Notification Four ......--}}
                     {{--</a>--}}
                  {{--</li>--}}
                  <li>
                     <a href="#">
                        <i class="fa fa-users text-aqua"></i> Notification Five ......
                     </a>
                  </li>
               </ul>
            </li>
            <li class="footer" style="height:auto !important; padding-top: 0px !important;"><a href="#">View all</a></li>
         </ul>
      </li>
