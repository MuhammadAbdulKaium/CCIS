        ...
        <div class="container-fluid">
            <div class="col-md-1" style="text-align: center">
                <a href="{{(Auth::user()->hasRole('super-admin')==true)?URL::to('/admin '):URL::to('/')}}">
                    ...
                    @else
                        {{--redireting--}}
                        <img src="{{url('assets/users/images/cadet-logo.png')}}" style="height: 70px" width="70px" align="center" class="brand-logo" alt="Alokito logo">
                    @endif
                </a>
            </div>
            @php    $campusName = getCampusProfile(); @endphp
            <div class="col-md-3" style="margin-bottom: 5px"><h2 class="school-name">
                    {{--institute profile checking--}}
                    @if(!empty(getInstituteProfile()))
                        {{--institute name--}}
