                    ...
                    <div class="col-md-2 hide_logo"  style="text-align: center; display: none;">
                        ...
                        @if(!empty(getInstituteProfile()))
                            ...
                            <a href="{{(Auth::user()->hasRole('super-admin')==true)?URL::to('/admin'):URL::to('/')}}">
                                <img src="{{url('assets/users/images/'.getInstituteProfile()->logo)}}" class="brand-logo" alt="Cadet College logo">
                            </a>
                        @else
                            {{--redireting--}}
                            <a href="{{(Auth::user()->hasRole('super-admin')==true)?URL::to('/superadmin'):URL::to('/')}}">
                                <img src="{{url('assets/users/images/cadet-logo.png')}}"  class="brand-logo" alt="All Cadet College logo">
                            </a>
                        @endif
                    </div>
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                        ...
                        @if(!empty(getInstituteProfile()))
                            {{--institute logo--}}
                            <a href="{{(Auth::user()->hasRole('super-admin')==true)?URL::to('/admin'):URL::to('/')}}">
                                <img src="{{url('assets/users/images/'.getInstituteProfile()->logo)}}"  class="brand-logo w-100" alt="Cadet College logo">
                        	</a>
                        @else
                            {{--redireting--}}
                            <a href="{{(Auth::user()->hasRole('super-admin')==true)?URL::to('/superadmin'):URL::to('/')}}">
            ...
            <div class="main-menu">
                <div class="menu-inner">
                    @include('layouts._header-mega-menu-v2')
                </div>
            </div>
        </div>
        ...
        <!-- Navbar -->
            ...
            <div class="header-area">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-sm-4 clearfix" style="display: flex;flex-wrap: nowrap;align-content: center;justify-content: flex-start;">
                        <div class="nav-btn pull-left d-inline">
                            ...
                            @if(in_array('levelofapproval/alert/notification', $menuAccess))
                                <ul class="pull-right" style="padding: 0; margin-left: 30px;">
