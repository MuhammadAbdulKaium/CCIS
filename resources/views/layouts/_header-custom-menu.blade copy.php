...
<div class="col-md-4" style="float: right">
    <div class="logo-button">
        ...
        <!-- Notifications: style can be found in dropdown.less -->
            ...
            {{-- <li class="approval-notification-icon">
                <a href="{{ url('/levelofapproval/alert/notification') }}" target="_blank">
                    <i class="fa fa-bell"></i>
                    @if ($numOfApprovalNotifications>0)
                        <span class="notification-badge">{{ $numOfApprovalNotifications }}</span>
                    @endif
                </a>
            </li> --}}
            <li class="dropdown">
